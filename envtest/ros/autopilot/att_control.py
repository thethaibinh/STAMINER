...
from autopilot.utils import quat_to_euler_angles, SqrtControllerAtt
...
ATTITUDE_CONTROL_ANGLE_YAW_P    = 0.05
...
RATE_CONTROL_YAW_P      = 0.180
RATE_CONTROL_YAW_I      = 0.018
RATE_CONTROL_YAW_D      = 0.0

ATTITUDE_ACCEL_RP_CONTROLLER_MAX_RADSS   = radians(720.0)
ATTITUDE_ACCEL_Y_CONTROLLER_MAX_RADSS    = radians(120.0)
...
class AttControllers:
    ...
    def update(self, states, des_CTBO):
        ...
        des_rate = np.zeros(3)
        des_rate[0] = self.pid_ang_roll(des_CTBO[1] - (-curr_att[0]), ATTITUDE_CONTROL_ANGLE_RP_P, ATTITUDE_ACCEL_RP_CONTROLLER_MAX_RADSS)
        des_rate[1] = self.pid_ang_pitch(des_CTBO[2] - (-curr_att[1]), ATTITUDE_CONTROL_ANGLE_RP_P, ATTITUDE_ACCEL_RP_CONTROLLER_MAX_RADSS)
        des_rate[2] = self.pid_ang_yaw(des_CTBO[3] - (-curr_att[2]), ATTITUDE_CONTROL_ANGLE_YAW_P, ATTITUDE_ACCEL_Y_CONTROLLER_MAX_RADSS)
